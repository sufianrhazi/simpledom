 ...
 */
export declare function one<T extends Element>(kind: Constructor<T>, selector: string): T;
/**
 ...
 * @param selector CSS selector to use for the search
 */
export declare function oneFrom<T extends Element>(
    kind: Constructor<T>,
 ...
 * @param selector CSS selector to use for the search
 */
export declare function all<T extends Element>(kind: Constructor<T>, selector: string): T[];
/**
 ...
 * @param selector CSS selector to use for the search
 */
export declare function allFrom<T extends Element>(
    kind: Constructor<T>,
    root: Element | Document,
    selector: string
): T[];
 ...
 */
export declare function on<K extends keyof ElementEventMap>(
    root: Element | Document,
    type: K,
    selector: string,
 ...
 */
export declare function build(html: string, doc?: Document): Element;
/**
 ...
 * @param doc the owning document of the DOM subtree (defaults to `document`)
 */
export declare function buildMany(html: string, doc?: Document): DocumentFragment;
```
